...
{
    public partial class NewRepositoryOnly : LayoutForCreateNewRepositoryOperation
    {
        private ILogger Logger { get; }


        public NewRepositoryOnly(
            ILogger<NewRepositoryOnly> logger)
        {
            InitializeComponent();
        ...
        private async void CreateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var repositoryLocations = await Instances.RepositoryOperations.CreateNew_RepositoryOnly(
                    gitHubOwner,
                    repositoryName,
                    description,
                    isPrivate,
